...
that to original page orientation for FE visualizations. rotation_to_original method
has done that for the above-mentioned document's page. 

Required: Testing in actual OCR pipeline